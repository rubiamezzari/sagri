        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          ...
          >
            ...
            {tipoUsuario === "operador" && (
              <>
                <li className="nav-item">
                  <NavLink className="nav-link" to="/agendamentos-operador" style={linkStyle}>
                    Agendamentos Designados
                  </NavLink>
                </li>
              </>
            )}
            ...
            {tipoUsuario === "admin" && (
              <>
                ...
                <li className="nav-item">
                  <NavLink className="nav-link" to="/agendamentos/list" style={linkStyle}>
                    Solicitações
                  </NavLink>
                </li>
              </>
